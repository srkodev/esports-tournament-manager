...
$tournoi_id = isset($_GET['tournoi_id']) ? $_GET['tournoi_id'] : die();

$stmt = $participation->readByTournoi($tournoi_id);
$num = $stmt->rowCount();
...
if($num > 0) {
    ...
    echo json_encode(array("message" => "Aucune participation trouvée pour ce tournoi."));
}
